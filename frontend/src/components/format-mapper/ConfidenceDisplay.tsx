...
import { ColumnHint, getConfidenceColors } from '@/types/customFormat'

// Icon component based on confidence level
export function ConfidenceIcon({ confidence, size = 'sm' }: { confidence: number; size?: 'sm' | 'lg' }) {
...
// Row showing confidence for a detected column
export function ColumnConfidenceRow({
  label,
  column,
  hint,
  isSet
