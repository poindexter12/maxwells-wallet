...
class ErrorCode(str, Enum):
    ...
    ASSISTANT_PROVIDER_ERROR = "ASSISTANT_PROVIDER_ERROR"
    ASSISTANT_PROPOSAL_NOT_FOUND = "ASSISTANT_PROPOSAL_NOT_FOUND"
    ASSISTANT_ACTION_NOT_ALLOWED = "ASSISTANT_ACTION_NOT_ALLOWED"
