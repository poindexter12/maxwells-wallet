...
Plans:
- [ ] 02-01-PLAN.md — Add OWASP Dependency-Check SCA scanning to security.yaml for npm and Python dependencies
- [ ] 02-02-PLAN.md — Create isolated OpenSSF Scorecard workflow for repository security posture assessment
